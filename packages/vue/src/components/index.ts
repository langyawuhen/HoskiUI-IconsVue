...
export { default as HoskiTalk } from './hoski-talk.vue'
export { default as HoskiCamera} from './hoski-camera.vue'
export { default as HoskiCameraColorful } from './hoski-camera-colorful.vue'
export { default as HoskiCar } from './hoski-car.vue'
export { default as HoskiCarDisplay } from './hoski-car-display.vue'
export { default as HoskiContanier } from './hoski-contanier.vue'
export { default as HoskiDirection } from './hoski-direction.vue'
export { default as HoskiEquipmentAttribute } from './hoski-equipment-attribute.vue'
export { default as HoskiEquipmentQuery } from './hoski-equipment-query.vue'
export { default as HoskiEquipmentSetting } from './hoski-equipment-setting.vue'
export { default as HoskiEyeClose } from './hoski-eye-close.vue'
export { default as HoskiEyeOpen } from './hoski-eye-open.vue'
export { default as HoskiFleet } from './hoski-fleet.vue'
export { default as HoskiHistoricalReplay } from './hoski-historical-replay.vue'
export { default as HoskiHome } from './hoski-home.vue'
export { default as HoskiLocation } from './hoski-location.vue'
export { default as HoskiLog } from './hoski-log.vue'
export { default as HoskiMenu } from './hoski-menu.vue'
export { default as HoskiMenuLeft } from './hoski-menu-left.vue'
export { default as HoskiMenuManage } from './hoski-menu-manage.vue'
export { default as HoskiMenuRight } from './hoski-menu-right.vue'
export { default as HoskiMotorcade } from './hoski-motorcade.vue'
export { default as HoskiOnlineUpdate } from './hoski-online-update.vue'
export { default as HoskiOption } from './hoski-option.vue'
export { default as HoskiProject } from './hoski-project.vue'
export { default as HoskiProjectManage } from './hoski-project-manage.vue'
export { default as HoskiRole } from './hoski-role.vue'
export { default as HoskiSafeCenter } from './hoski-safe-center.vue'
export { default as HoskiScreen } from './hoski-screen.vue'
export { default as HoskiServer } from './hoski-server.vue'
export { default as HoskiStartTalk } from './hoski-start-talk.vue'
export { default as HoskiStatics} from './hoski-statics.vue'
export { default as HoskiStatistics } from './hoski-statistics.vue'
export { default as HoskiStop } from './hoski-stop.vue'
export { default as HoskiSystem } from './hoski-system.vue'
export { default as HoskiVehicleUser } from './hoski-vehicle-user.vue'
